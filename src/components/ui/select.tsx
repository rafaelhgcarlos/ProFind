...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      {...props}
    >
      <SelectPrimitive.ScrollUpButton className="flex h-7 cursor-pointer items-center justify-center">
      ...
      <SelectPrimitive.ScrollDownButton className="flex h-7 cursor-pointer items-center justify-center">
